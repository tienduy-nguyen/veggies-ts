...
export class HttpApiClient {
    ...
    public query: object | null = null
    public cookies: Properties[] = []
    public cookieJar: CookieJar | null = null
    public followRedirect = true
    public response: Response | null = null
    public responseCookies: Record<string, Cookie> = {}

    private static _instance: HttpApiClient
    private constructor() {
        this.reset()
    }

    public static getInstance(): HttpApiClient {
...
export const httpApiClient = HttpApiClient.getInstance()
